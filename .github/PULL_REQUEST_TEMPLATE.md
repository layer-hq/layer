...
<!-- `swift test`, and what you exercised by hand. Screenshot or recording for UI changes. -->
...
- [ ] If it does, the description below says exactly how, and the README's
      "Privacy and permissions" section is updated to match.
